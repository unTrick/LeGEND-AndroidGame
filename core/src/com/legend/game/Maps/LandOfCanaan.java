...
public class LandOfCanaan extends GameState {
    ...
    public LandOfCanaan(GameStateManager gsm){
        super(gsm);
        ...
        map = mapLoader.load("tiledmaps/Land-of-Canaan.tmx");
...
//            walkDown();
    ...
    public void render(SpriteBatch sb) {
        ...
        hud.getMapName().setText("Land Of Canaan");
        hud.stage.draw();
    }
