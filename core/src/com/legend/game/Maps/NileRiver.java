...
public class NileRiver extends GameState{
    ...
    public NileRiver(GameStateManager gsm){
        super(gsm);
        ...
        map = mapLoader.load("tiledmaps/Nile River.tmx");
...
//            walkDown();
    ...
    public void update(float dt) {
        ...
        hud.getMapName().setText("Nile River");
        hud.update(dt);
    }
