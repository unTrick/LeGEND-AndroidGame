package com.legend.game.BibleBooks;
...
/**
 * Created by Patrick Sky on 3/5/2017.
 */
...
public class BookOfExodus {
        ...
        BitmapFont titleFont, contentFont, numberFont;

        Label lblmainTitle;
        Label txtFirstContent, txtSecondContent, txtThirdContent, txtFourthContent;
        Label lblFirstTitle, lblSecondTitle, lblThirdTitle, lblFourthTitle;
        Label lblChapterNumber;
        ...
        public BookOfExodus() { // kung ano yung filename yun din yung public keme
            ...
            FreeTypeFontGenerator.FreeTypeFontParameter numberParameter = new FreeTypeFontGenerator.FreeTypeFontParameter();
            numberParameter.size = 30;
            numberFont = generator.generateFont(numberParameter);
        ...
        public void chapterOneOFExodus() { // yung method/function ng per chapter.
            table1 = new Table();
            table1.top().left().padTop(200);
            table1.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "1";

            String chapterFirstTitle = "Israel Increases Greatly in Egypt"; // sample content titleParameter
            ...
            String secondContent = "8 Now there arose a new king over Egypt, who did not know Joseph.\n" +
                    ...
                    "22 Then Pharaoh commanded all his people, “Every son that is born to the Hebrews1 you shall cast into the Nile, but you shall let every daughter live.”\n";

            lblmainTitle = new Label(mainTitle, new com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle(titleFont, Color.BLACK)); // ito yung pag gawa ng text, message, label. yung paki intindi nalang, may tiwala ako sayo

            lblChapterNumber = new Label(chapterNumber, new Label.LabelStyle(numberFont, Color.BLACK));

            lblFirstTitle = new Label(chapterFirstTitle, new Label.LabelStyle(contentFont, Color.BLACK));

            lblSecondTitle = new Label(chapterSecondTitle, new Label.LabelStyle(contentFont, Color.BLACK));

            txtFirstContent = new Label(firstContent, new Label.LabelStyle(contentFont, Color.BLACK));

            txtSecondContent = new Label(secondContent, new Label.LabelStyle(contentFont, Color.BLACK));


            //book name
            table1.add(lblmainTitle).center().pad(20,0,0,20);
            table1.row(); // adding a row to the table

            //number of chapter
            table1.add(lblChapterNumber).pad(10,50,0,0).left();
            table1.row();
            ...
            table1.add(txtFirstContent).pad(10,70,0,0).left();
            table1.row();
            ...
            table1.add(txtSecondContent).pad(10,70,0,0).left();

        }


        public void chapterTwoOFExodus() { // yung method/function ng per chapter.
            table2 = new Table();
            table2.top().left().padTop(200);
            ...
            String chapterFirstTitle = "The Birth of Moses"; // sample content titleParameter

            String firstContent = "1 Now a man from the house of Levi went and took as his wife a Levite woman. \n" +
                    "2 The woman conceived and bore a son, and when she saw that he was a fine child, she hid him three months. \n" +
                    "3 When she could hide him no longer, she took for him a basket made of bulrushes1and daubed it with bitumen and pitch. She put the child in it and placed it among the reeds by the river bank. \n" +
            ...
            String secondContent = "11 One day, when Moses had grown up, he went out to his people and looked on their burdens, and he saw an Egyptian beating a Hebrew, one of his people.\n" +
                    ...
                    "24 And God heard their groaning, and God remembered his covenant with tAbraham, with Isaac, and with Jacob. 25 God saw the people of Israel—and God knew.\n";
            ...
            //book name
            table2.add(lblmainTitle).center().pad(20,0,0,20);
            table2.row(); // adding a row to the table

            //number of chapter
            table2.add(lblChapterNumber).pad(10,50,0,0).left();
            table2.row();
            ...
            //content of the chapter
            table2.add(txtFirstContent).pad(10,70,0,0).left();
            table2.row();
            ...
            //content of the second title
            table2.add(txtSecondContent).pad(10,70,0,0).left();
        ...
        public void chapterThreeOFExodus() { // yung method/function ng per chapter.
            table3 = new Table();
            table3.top().left().padTop(200);
            table3.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "3";

            String chapterFirstTitle = "The Burning Bush"; // sample content titleParameter

            String firstContent = "1 Now Moses was keeping the flock of his father-in-law, Jethro, the priest of Midian, and he led his flock to the west side of the wilderness and came to Horeb, the mountain of God. \n" +
                    ...
                    "16 Go and gather the elders of Israel together and say to them, ‘The LORD, the God of your fathers, the God of Abraham, of Isaac, and of Jacob, has appeared to me, saying, v“I have observed you and what has been done to you in Egypt, \n" +
            ...
            //book name
            table3.add(lblmainTitle).center().pad(20,0,0,20);
            table3.row(); // adding a row to the table

            //number of chapter
            table3.add(lblChapterNumber).pad(10,50,0,0).left();
            table3.row();
            ...
            //content of the chapter
            table3.add(txtFirstContent).pad(10,70,0,0).left();


        }

        public void chapterFourOFExodus() { // yung method/function ng per chapter.
            table4 = new Table();
            table4.top().left().padTop(200);
            table4.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "4";

            String chapterFirstTitle = "Moses Given Powerful Signs"; // sample content titleParameter

            String firstContent = "1 Then Moses answered, “But behold, they will not believe me or listen to my voice, for they will say, ‘The LORD did not appear to you.’” \n" +
                    ...
                    "25 Then Zipporah took a flint and cut off her son's foreskin and touched Moses'3 feet with it and said, “Surely you are a bridegroom of blood to me!” \n" +
            ...
            //book name
            table4.add(lblmainTitle).center().pad(20,0,0,20);
            table4.row(); // adding a row to the table

            //number of chapter
            table4.add(lblChapterNumber).pad(10,50,0,0).left();
            table4.row();
            ...
            //content of the chapter
            table4.add(txtFirstContent).pad(10,70,0,0).left();


        }

        public void chapterFiveOFExodus() { // yung method/function ng per chapter.
            table5 = new Table();
            table5.top().left().padTop(200);
            table5.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "5";

            String chapterFirstTitle = "Making Bricks Without Straw"; // sample content titleParameter

            String firstContent = "1 Afterward Moses and Aaron went and said to Pharaoh, “Thus says the LORD, the God of Israel, ‘Let my people go, that they may hold ta feast to me in the wilderness.’” \n" +
            ...
            //book name
            table5.add(lblmainTitle).center().pad(20,0,0,20);
            table5.row(); // adding a row to the table

            //number of chapter
            table5.add(lblChapterNumber).pad(10,50,0,0).left();
            table5.row();
            ...
            //content of the chapter
            table5.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterSixOFExodus() { // yung method/function ng per chapter.
            table6 = new Table();
            table6.top().left().padTop(200);
            table6.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "6";

            String chapterFirstTitle = "God Promises Deliverance"; // sample content titleParameter

            String firstContent = "1 But the LORD said to Moses, “Now you shall see what I will do to Pharaoh; for with a strong hand he will send them out, and with a strong hand he will drive them out of his land.”\n" +
                    ...
                    "6 Say therefore to the people of Israel, ‘I am the LORD, and I will bring you out from under the burdens of the Egyptians, and I will deliver you from slavery to them, and oI will redeem you with an outstretched arm and with great acts of judgment.\n" +
                    "7 I will take you to be my people, and I will be your God, and you shall know that mI am the LORD your God, who has brought you out from under the burdens of the Egyptians. \n" +
            ...
            String secondContent = "14 These are the heads of their fathers' houses: the sons of Reuben, the firstborn of Israel: Hanoch, Pallu, Hezron, and Carmi; these are the clans of Reuben. \n" +
            ...
            //book name
            table6.add(lblmainTitle).center().pad(20,0,0,20);
            table6.row(); // adding a row to the table

            //number of chapter
            table6.add(lblChapterNumber).pad(10,50,0,0).left();
            table6.row();
            ...
            //content of the chapter
            table6.add(txtFirstContent).pad(10,70,0,0).left();
            table6.row();
            ...
            //content of the second title
            table6.add(txtSecondContent).pad(10,70,0,0).left();


        }

        public void chapterSevenOFExodus() { // yung method/function ng per chapter.
            table7 = new Table();
            table7.top().left().padTop(200);
            table7.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "7";

            String chapterFirstTitle = "Moses and Aaron Before Pharaoh"; // sample content titleParameter
            ...
            //book name
            table7.add(lblmainTitle).center().pad(20,0,0,20);
            table7.row(); // adding a row to the table

            //number of chapter
            table7.add(lblChapterNumber).pad(10,50,0,0).left();
            table7.row();
            ...
            //content of the chapter
            table7.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterEightOFExodus() { // yung method/function ng per chapter.
            table8 = new Table();
            table8.top().left().padTop(200);
            table8.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "8";

            String chapterFirstTitle = "The Second Plague: Frogs"; // sample content titleParameter

            String firstContent = "1 Then the LORD said to Moses, “Go in to Pharaoh and say to him, ‘Thus says the LORD, “Let my people go, that they may serve me.\n" +
                    ...
                    " 5 3 And the LORD said to Moses, “Say to Aaron, ‘Stretch out your hand with your staff over the rivers, over the canals and over the pools, and make frogs come up on the land of Egypt!’” \n" +
            ...
            String secondContent = "16 Then the LORD said to Moses, “Say to Aaron, ‘Stretch out your staff and strike the dust of the earth, so that it may become gnats in all the land of Egypt.’” \n" +
            ...
            String thirdContent = "20 Then the LORD said to Moses, “Rise up early in the morning and present yourself to Pharaoh, as he goes out to the water, and say to him, ‘Thus says the LORD, “Let my people go, that they may serve me. \n" +
                    ...
                    "22 But on that day I will set apart the land of Goshen, where my people dwell, so that no swarms of flies shall be there, that you may know that I am the LORD in the midst of the earth.5 \n" +
            ...
            lblThirdTitle = new Label(chapterThirdTitle, new Label.LabelStyle(contentFont, Color.BLACK));

            txtFirstContent = new Label(firstContent, new Label.LabelStyle(contentFont, Color.BLACK));

            txtSecondContent = new Label(secondContent, new Label.LabelStyle(contentFont, Color.BLACK));

            txtThirdContent = new Label(thirdContent, new Label.LabelStyle(contentFont, Color.BLACK));


            //book name
            table8.add(lblmainTitle).center().pad(20,0,0,20);
            table8.row(); // adding a row to the table

            //number of chapter
            table8.add(lblChapterNumber).pad(10,50,0,0).left();
            table8.row();
            ...
            //content of the chapter
            table8.add(txtFirstContent).pad(10,70,0,0).left();
            table8.row();
            ...
            //content of the second title
            table8.add(txtSecondContent).pad(10,70,0,0).left();
            table8.row();
            ...
            table8.add(txtThirdContent).pad(10,70,0,0).left();


        }


        public void chapterNineOFExodus() { // yung method/function ng per chapter.
            table9 = new Table();
            table9.top().left().padTop(200);
            table9.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "9";

            String chapterFirstTitle = "The Fifth Plague: Egyptian Livestock Die"; // sample content titleParameter

            String firstContent = "1 Then the LORD said to Moses, “Go in to Pharaoh and say to him, ‘Thus says qthe LORD, the God of the Hebrews, “Let my people go, that they may serve me. \n" +
            ...
            String secondContent = "8 And the LORD said to Moses and Aaron, “Take handfuls of soot from the kiln, and let Moses throw them in the air in the sight of Pharaoh. \n" +
            ...
            String thirdContent = "13 Then the LORD said to Moses, “Rise up early in the morning and present yourself before Pharaoh and say to him, ‘Thus says the LORD, the God of the Hebrews, “Let my people go, that they may serve me.\n" +
                    "14 For this time I will send all my plagues on you yourself,1 and on your servants and your people, so that you may know that there is none like me in all the earth. \n" +
                    ...
                    "23 Then Moses stretched out his staff toward heaven, and the GLORD sent thunder and hail, and fire ran down to the earth. And the LORD rained hail upon the land of Egypt.\n" +
                    ...
                    "27 Then Pharaoh sent and called Moses and Aaron and said to them, “This time jI have sinned; the LORD is in the right, and I and my people are in the wrong. \n" +
            ...
            //book name
            table9.add(lblmainTitle).center().pad(20,0,0,20);
            table9.row(); // adding a row to the table

            //number of chapter
            table9.add(lblChapterNumber).pad(10,50,0,0).left();
            table9.row();
            ...
            //content of the chapter
            table9.add(txtFirstContent).pad(10,70,0,0).left();
            table9.row();
            ...
            //content of the second title
            table9.add(txtSecondContent).pad(10,70,0,0).left();
            table9.row();
            ...
            //content of the third title
            table9.add(txtThirdContent).pad(10,70,0,0).left();


        }

        public void chapterTenOFExodus() { // yung method/function ng per chapter.
            table10 = new Table();
            table10.top().left().padTop(200);
            table10.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "10";

            String chapterFirstTitle = "The Eighth Plague: Locusts"; // sample content titleParameter

            String firstContent = "1 Then the LORD said to Moses, “Go in to Pharaoh, for I have hardened his heart and the heart of his servants, that I may show these signs of mine among them, \n" +
            ...
            String secondContent = "21 Then the LORD said to Moses, “Stretch out your hand toward heaven, that there may be darkness over the land of Egypt, a darkness to be felt.” \n" +
            ...
            //book name
            table10.add(lblmainTitle).center().pad(20,0,0,20);
            table10.row(); // adding a row to the table

            //number of chapter
            table10.add(lblChapterNumber).pad(10,50,0,0).left();
            table10.row();
            ...
            //content of the chapter
            table10.add(txtFirstContent).pad(10,70,0,0).left();
            table10.row();
            ...
            //content of the second title
            table10.add(txtSecondContent).pad(10,70,0,0).left();


        }


        public void chapterElevenOFExodus() { // yung method/function ng per chapter.
            table11 = new Table();
            table11.top().left().padTop(200);
            table11.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "11";

            String chapterFirstTitle = "A Final Plague Threatened"; // sample content titleParameter

            String firstContent = "1 The LORD said to Moses, “Yet one plague more I will bring upon Pharaoh and upon Egypt. Afterward he will let you go from here. When he lets you go, he will drive you away completely. \n" +
                    ...
                    "8 And ball these your servants shall come down to me and bow down to me, saying, ‘Get out, you and all the people who follow you.’ And after that I will go out.” And he went out from Pharaoh in hot anger.\n" +
            ...
            //book name
            table11.add(lblmainTitle).center().pad(20,0,0,20);
            table11.row(); // adding a row to the table

            //number of chapter
            table11.add(lblChapterNumber).pad(10,50,0,0).left();
            table11.row();
            ...
            //content of the chapter
            table11.add(txtFirstContent).pad(10,70,0,0).left();

        }

        public void chapterTwelveOFExodus() { // yung method/function ng per chapter.
            table12 = new Table();
            table12.top().left().padTop(200);
            table12.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "12";

            String chapterFirstTitle = "The Passover"; // sample content titleParameter
            ...
            String chapterSecondTitle = "The Tenth Plague: Death of the Firstborn"; // sample content titleParameter

            String secondContent = "29 At midnight the Lord struck down all the firstborn in the land of Egypt, from the firstborn of Pharaoh who sat on his throne to the firstborn of the captive who was in the dungeon, and all the firstborn of the livestock. \n" +
            ...
            String chapterThirdTitle = "The Exodus"; // sample content titleParameter
            ...
            String chapterFourthTitle = "Institution of the Passover"; // sample content titleParameter
            ...
            lblFourthTitle = new Label(chapterFourthTitle, new Label.LabelStyle(contentFont, Color.BLACK));
            ...
            txtFourthContent = new Label(fourthContent, new Label.LabelStyle(contentFont, Color.BLACK));


            //book name
            table12.add(lblmainTitle).center().pad(20,0,0,20);
            table12.row(); // adding a row to the table

            //number of chapter
            table12.add(lblChapterNumber).pad(10,50,0,0).left();
            table12.row();
            ...
            //content of the second title
            table12.add(txtSecondContent).pad(10,70,0,0).left();
            table12.row();
            ...
            //content of the third title
            table12.add(txtThirdContent).pad(10,70,0,0).left();


        }


        public void chapterThirteenOFExodus() { // yung method/function ng per chapter.
            table13 = new Table();
            table13.top().left().padTop(200);
            table13.setFillParent(true);


            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "13";

            String chapterFirstTitle = "Consecration of the Firstborn"; // sample content titleParameter
            ...
            String chapterSecondTitle = "The Feast of Unleavened Bread"; // sample content titleParameter

            String secondContent = "3 Then Moses said to the people, “Remember this day in which you came out from Egypt, out of the house of slavery, for by a strong hand the Lord brought you out from this place. No leavened bread shall be eaten.\n" +
            ...
            String chapterThirdTitle = "Pillars of Cloud and Fire"; // sample content titleParameter

            String thirdContent = "17 When Pharaoh let the people go, God did not lead them by way of the land of the Philistines, although that was near. For God said, “Lest the people change their minds when they see war and return to Egypt.”\n" +
            ...
            //book name
            table13.add(lblmainTitle).center().pad(20,0,0,20);
            table13.row(); // adding a row to the table

            //number of chapter
            table13.add(lblChapterNumber).pad(10,50,0,0).left();
            table13.row();
            ...
            //content of the chapter
            table13.add(txtFirstContent).pad(10,70,0,0).left();
            table13.row();
            ...
            //content of the second title
            table13.add(txtSecondContent).pad(10,70,0,0).left();
            table13.row();
            ...
            //content of the third title
            table13.add(txtThirdContent).pad(10,70,0,0).left();
        ...
        public void chapterFourteenOFExodus() { // yung method/function ng per chapter.
            table14 = new Table();
            table14.top().left().padTop(200);
            table14.setFillParent(true);

            String mainTitle = "The Book of Exodus"; // sample main title

            String chapterNumber = "14";

            String chapterFirstTitle = "Crossing the Red Sea"; // sample content titleParameter
            ...
            //book name
            table14.add(lblmainTitle).center().pad(20,0,0,20);
            table14.row(); // adding a row to the table

            //number of chapter
            table14.add(lblChapterNumber).pad(10,50,0,0).left();
            table14.row();
            ...
            //content of the chapter
            table14.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterFifteenOFExodus() { // yung method/function ng per chapter.
            table15 = new Table();
            table15.top().left().padTop(200);
            table15.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "15";

            String chapterFirstTitle = "The Song of Moses"; // sample content titleParameter
            ...
            String chapterSecondTitle = "Bitter Water Made Sweet"; // sample content titleParameter

            String secondContent = "22 Then Moses made Israel set out from the Red Sea, and they went into the wilderness of Shur. They went three days in the wilderness and found no water. \n" +
            ...
            //book name
            table15.add(lblmainTitle).center().pad(20,0,0,20);
            table15.row(); // adding a row to the table

            //number of chapter
            table15.add(lblChapterNumber).pad(10,50,0,0).left();
            table15.row();
            ...
            //content of the chapter
            table15.add(txtFirstContent).pad(10,70,0,0).left();
            table15.row();
            ...
            //content of the second title
            table15.add(txtSecondContent).pad(10,70,0,0).left();

        }


        public void chapterSixteenOFExodus() { // yung method/function ng per chapter.
            table16 = new Table();
            table16.top().left().padTop(200);
            table16.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "16";

            String chapterFirstTitle = "Bread from Heaven"; // sample content titleParameter

            String firstContent = "1 They set out from Elim, and all the congregation of the people of Israel came to the wilderness of Sin, which is between Elim and Sinai, on the fifteenth day of the second month after they had departed from the land of Egypt.\n" +
            ...
            //book name
            table16.add(lblmainTitle).center().pad(20,0,0,20);
            table16.row(); // adding a row to the table

            //number of chapter
            table16.add(lblChapterNumber).pad(10,50,0,0).left();
            table16.row();
            ...
            //content of the chapter
            table16.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterSeventeenOFExodus() { // yung method/function ng per chapter.
            table17 = new Table();
            table17.top().left().padTop(200);
            table17.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "17";

            String chapterFirstTitle = "Water from the Rock"; // sample content titleParameter

            String firstContent = "1 All the congregation of the people of Israel moved on from the wilderness of Sin by stages, according to the commandment of the Lord, and camped at Rephidim, but there was no water for the people to drink.\n" +
            ...
            String chapterSecondTitle = "Israel Defeats Amalek"; // sample content titleParameter
            ...
            //book name
            table17.add(lblmainTitle).center().pad(20,0,0,20);
            table17.row(); // adding a row to the table

            //number of chapter
            table17.add(lblChapterNumber).pad(10,50,0,0).left();
            table17.row();
            ...
            //content of the chapter
            table17.add(txtFirstContent).pad(10,70,0,0).left();
            table17.row();
            ...
            //content of the second title
            table17.add(txtSecondContent).pad(10,70,0,0).left();


        }


        public void chapterEighteenOFExodus() { // yung method/function ng per chapter.
            table18 = new Table();
            table18.top().left().padTop(200);
            table18.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "18";

            String chapterFirstTitle = "Jethro's Advice"; // sample content titleParameter

            String firstContent = "1 Jethro, the priest of Midian, Moses' father-in-law, heard of all that God had done for Moses and for Israel his people, how the Lord had brought Israel out of Egypt. \n" +
                    ...
                    "26 And they judged the people at all times. Any hard case they brought to Moses, but any small matter they decided themselves. 27 Then Moses let his father-in-law depart, and he went away to his own country.\n";
            ...
            //book name
            table18.add(lblmainTitle).center().pad(20,0,0,20);
            table18.row(); // adding a row to the table

            //number of chapter
            table18.add(lblChapterNumber).pad(10,50,0,0).left();
            table18.row();
            ...
            //content of the chapter
            table18.add(txtFirstContent).pad(10,70,0,0).left();


        }


        public void chapterNineteenOFExodus() { // yung method/function ng per chapter.
            table19 = new Table();
            table19.top().left().padTop(200);
            table19.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "19";

            String chapterFirstTitle = "Israel at Mount Sinai"; // sample content titleParameter

            String firstContent = "1 On the third new moon after the people of Israel had gone out of the land of Egypt, on that day they came into the wilderness of Sinai. \n" +
            ...
            //book name
            table19.add(lblmainTitle).center().pad(20,0,0,20);
            table19.row(); // adding a row to the table

            //number of chapter
            table19.add(lblChapterNumber).pad(10,50,0,0).left();
            table19.row();
            ...
            //content of the chapter
            table19.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterTwentyOFExodus() { // yung method/function ng per chapter.
            table20 = new Table();
            table20.top().left().padTop(200);
            table20.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "20";

            String chapterFirstTitle = "The Ten Commandments"; // sample content titleParameter
            ...
            String chapterSecondTitle = "Laws About Altars"; // sample content titleParameter

            String secondContent = "22 And the Lord said to Moses, “Thus you shall say to the people of Israel: ‘You have seen for yourselves that I have talked with you from heaven. \n" +
            ...
            //book name
            table20.add(lblmainTitle).center().pad(20,0,0,20);
            table20.row(); // adding a row to the table

            //number of chapter
            table20.add(lblChapterNumber).pad(10,50,0,0).left();
            table20.row();
            ...
            //content of the chapter
            table20.add(txtFirstContent).pad(10,70,0,0).left();
            table20.row();
            ...
            //content of the second title
            table20.add(txtSecondContent).pad(10,70,0,0).left();

        }

        public void chapterTwentyOneOFExodus() { // yung method/function ng per chapter.
            table21 = new Table();
            table21.top().left().padTop(200);
            table21.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "21";

            String chapterFirstTitle = "Laws About Slaves"; // sample content titleParameter
            ...
            String chapterSecondTitle = "Laws About Restitution"; // sample content titleParameter
            ...
            //book name
            table21.add(lblmainTitle).center().pad(20,0,0,20);
            table21.row(); // adding a row to the table

            //number of chapter
            table21.add(lblChapterNumber).pad(10,50,0,0).left();
            table21.row();
            ...
            //content of the chapter
            table21.add(txtFirstContent).pad(10,70,0,0).left();
            table21.row();
            ...
            //content of the second title
            table21.add(txtSecondContent).pad(10,70,0,0).left();

        }


        public void chapterTwentyTwoOFExodus() { // yung method/function ng per chapter.
            table22 = new Table();
            table22.top().left().padTop(200);
            table22.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "22";

            String chapterFirstTitle = " "; // sample content titleParameter
            ...
            String chapterSecondTitle = "Laws About Social Justice"; // sample content titleParameter
            ...
            //book name
            table22.add(lblmainTitle).center().pad(20,0,0,20);
            table22.row(); // adding a row to the table

            //number of chapter
            table22.add(lblChapterNumber).pad(10,50,0,0).left();
            table22.row();
            ...
            //content of the chapter
            table22.add(txtFirstContent).pad(10,70,0,0).left();
            table22.row();
            ...
            //content of the second title
            table22.add(txtSecondContent).pad(10,70,0,0).left();

        }


        public void chapterTwentyThreeOFExodus() { // yung method/function ng per chapter.
            table23 = new Table();
            table23.top().left().padTop(200);
            table23.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "23";
            ...
            String chapterSecondTitle = "Laws About the Sabbath and Festivals"; // sample content titleParameter
            ...
            String chapterThirdTitle = "Conquest of Canaan Promised"; // sample content titleParameter
            ...
            //book name
            table23.add(lblmainTitle).center().pad(20,0,0,20);
            table23.row(); // adding a row to the table

            //number of chapter
            table23.add(lblChapterNumber).pad(10,50,0,0).left();
            table23.row();
            ...
            //content of the chapter
            table23.add(txtFirstContent).pad(10,70,0,0).left();
            table23.row();
            ...
            //content of the second title
            table23.add(txtSecondContent).pad(10,70,0,0).left();
            table23.row();
            ...
            //content of the third title
            table23.add(txtThirdContent).pad(10,70,0,0).left();


        }


        public void chapterTwentyFourOFExodus() { // yung method/function ng per chapter.
            table24 = new Table();
            table24.top().left().padTop(200);
            table24.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "24";

            String chapterFirstTitle = "The Covenant Confirmed"; // sample content titleParameter

            String firstContent = "1 Then he said to Moses, “Come up to the Lord, you and Aaron, Nadab, and Abihu, and seventy of the elders of Israel, and worship from afar. \n" +
            ...
            //book name
            table24.add(lblmainTitle).center().pad(20,0,0,20);
            table24.row(); // adding a row to the table

            //number of chapter
            table24.add(lblChapterNumber).pad(10,50,0,0).left();
            table24.row();
            ...
            //content of the chapter
            table24.add(txtFirstContent).pad(10,70,0,0).left();


        }

        public void chapterTwentyFiveOFExodus() { // yung method/function ng per chapter.
            table25 = new Table();
            table25.top().left().padTop(200);
            table25.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "25";

            String chapterFirstTitle = "Contributions for the Sanctuary"; // sample content titleParameter
            ...
            String chapterSecondTitle = "The Ark of the Covenant"; // sample content titleParameter

            String secondContent = "10 “They shall make an ark of acacia wood. Two cubits and a half shall be its length, a cubit and a half its breadth, and a cubit and a half its height. \n" +
            ...
            String chapterThirdTitle = "The Table for Bread"; // sample content titleParameter
            ...
            String chapterFourthTitle = "The Golden Lampstand"; // sample content titleParameter

            String fourthContent = "31 “You shall make a lampstand of pure gold. The lampstand shall be made of hammered work: its base, its stem, its cups, its calyxes, and its flowers shall be of one piece with it. \n" +
            ...
            //book name
            table25.add(lblmainTitle).center().pad(20,0,0,20);
            table25.row(); // adding a row to the table

            //number of chapter
            table25.add(lblChapterNumber).pad(10,50,0,0).left();
            table25.row();
            ...
            //content of the chapter
            table25.add(txtFirstContent).pad(10,70,0,0).left();
            table25.row();
            ...
            //content of the second title
            table25.add(txtSecondContent).pad(10,70,0,0).left();
            table25.row();
            ...
            //content of the third title
            table25.add(txtThirdContent).pad(10,70,0,0).left();
            ...
            table25.add(txtFourthContent).pad(10,70,0,0).left();

        }

        public void chapterTwentySixOFExodus() { // yung method/function ng per chapter.
            table26 = new Table();
            table26.top().left().padTop(200);
            table26.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "26";

            String chapterFirstTitle = "The Tabernacle"; // sample content titleParameter

            String firstContent = "1 “Moreover, you shall make the tabernacle with ten curtains of fine twined linen and blue and purple and scarlet yarns; you shall make them with cherubim skillfully worked into them. \n" +
            ...
            //book name
            table26.add(lblmainTitle).center().pad(20,0,0,20);
            table26.row(); // adding a row to the table

            //number of chapter
            table26.add(lblChapterNumber).pad(10,50,0,0).left();
            table26.row();
            ...
            //content of the chapter
            table26.add(txtFirstContent).pad(10,70,0,0).left();


        }

        public void chapterTwentySevenOFExodus() { // yung method/function ng per chapter.
            table27 = new Table();
            table27.top().left().padTop(200);
            table27.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "27";

            String chapterFirstTitle = "The Bronze Altar"; // sample content titleParameter

            String firstContent = "1 “You shall make the altar of acacia wood, five cubits long and five cubits broad. The altar shall be square, and its height shall be three cubits. \n" +
            ...
            String chapterSecondTitle = "The Court of the Tabernacle"; // sample content titleParameter

            String secondContent = "9 “You shall make the court of the tabernacle. On the south side the court shall have hangings of fine twined linen a hundred cubits long for one side. \n" +
            ...
            String chapterThirdTitle = "Oil for the Lamp"; // sample content titleParameter

            String thirdContent = "20 “You shall command the people of Israel that they bring to you pure beaten olive oil for the light, that a lamp may regularly be set up to burn. \n" +
            ...
            //book name
            table27.add(lblmainTitle).center().pad(20,0,0,20);
            table27.row(); // adding a row to the table

            //number of chapter
            table27.add(lblChapterNumber).pad(10,50,0,0).left();
            table27.row();
            ...
            //content of the chapter
            table27.add(txtFirstContent).pad(10,70,0,0).left();
            table27.row();
            ...
            //content of the second title
            table27.add(txtSecondContent).pad(10,70,0,0).left();
            table27.row();
            ...
            //content of the third title
            table27.add(txtThirdContent).pad(10,70,0,0).left();

        }


        public void chapterTwentyEightOFExodus() { // yung method/function ng per chapter.
            table28 = new Table();
            table28.top().left().padTop(200);
            table28.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "28";

            String chapterFirstTitle = "The Priests' Garments"; // sample content titleParameter

            String firstContent = "1 “Then bring near to you Aaron your brother, and his sons with him, from among the people of Israel, to serve me as priests—Aaron and Aaron's sons, Nadab and Abihu, Eleazar and Ithamar. \n" +
            ...
            //book name
            table28.add(lblmainTitle).center().pad(20,0,0,20);
            table28.row(); // adding a row to the table

            //number of chapter
            table28.add(lblChapterNumber).pad(10,50,0,0).left();
            table28.row();
            ...
            //content of the chapter
            table28.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterTwentyNineOFExodus() { // yung method/function ng per chapter.
            table29 = new Table();
            table29.top().left().padTop(200);
            table29.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "29";

            String chapterFirstTitle = "Consecration of the Priests"; // sample content titleParameter

            String firstContent = "1 “Now this is what you shall do to them to consecrate them, that they may serve me as priests. Take one bull of the herd and two rams without blemish, \n" +
            ...
            //book name
            table29.add(lblmainTitle).center().pad(20,0,0,20);
            table29.row(); // adding a row to the table

            //number of chapter
            table29.add(lblChapterNumber).pad(10,50,0,0).left();
            table29.row();
            ...
            //content of the chapter
            table29.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterThirtyOFExodus() { // yung method/function ng per chapter.
            table30 = new Table();
            table30.top().left().padTop(200);
            table30.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "30";

            String chapterFirstTitle = "The Altar of Incense"; // sample content titleParameter
            ...
            String chapterSecondTitle = "The Census Tax"; // sample content titleParameter
            ...
            String secondContent = "11 The Lord said to Moses, \n" +
                    ...
                    "13 Each one who is numbered in the census shall give this: half a sheke according to the shekel of the sanctuary (the shekel is twenty gerahs),half a shekel as an offering to the Lord. \n" +
            ...
            String chapterThirdTitle = "The Bronze Basin"; // sample content titleParameter
            ...
            String chapterFourthTitle = "The Anointing Oil and Incense"; // sample content titleParameter
            ...
            //book name
            table30.add(lblmainTitle).center().pad(20,0,0,20);
            table30.row(); // adding a row to the table

            //number of chapter
            table30.add(lblChapterNumber).pad(10,50,0,0).left();
            table30.row();
            ...
            //content of the chapter
            table30.add(txtFirstContent).pad(10,70,0,0).left();
            table30.row();
            ...
            //content of the second title
            table30.add(txtSecondContent).pad(10,70,0,0).left();
            table30.row();
            ...
            //content of the third title
            table30.add(txtThirdContent).pad(10,70,0,0).left();
            ...
            //content of the fourtn title
            table30.add(txtFourthContent).pad(10,70,0,0).left();

        }


        public void chapterThirtyOneOFExodus() { // yung method/function ng per chapter.
            table31 = new Table();
            table31.top().left().padTop(200);
            table31.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "31";

            String chapterFirstTitle = "Oholiab and Bezalel"; // sample content titleParameter
            ...
            String chapterSecondTitle = "The Sabbath"; // sample content titleParameter
            ...
            //book name
            table31.add(lblmainTitle).center().pad(20,0,0,20);
            table31.row(); // adding a row to the table

            //number of chapter
            table31.add(lblChapterNumber).pad(10,50,0,0).left();
            table31.row();
        ...
        public void chapterThirtyTwoOFExodus() { // yung method/function ng per chapter.
            table32 = new Table();
            table32.top().left().padTop(200);
            table32.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "32";

            String chapterFirstTitle = "The Golden Calf"; // sample content titleParameter

            String firstContent = "1 When the people saw that Moses delayed to come down from the mountain, the people gathered themselves together to Aaron and said to him, “Up, make us gods who shall go before us. As for this Moses, the man who brought us up out of the land of Egypt, we do not know what has become of him.” \n" +
            ...
            //book name
            table32.add(lblmainTitle).center().pad(20,0,0,20);
            table32.row(); // adding a row to the table

            //number of chapter
            table32.add(lblChapterNumber).pad(10,50,0,0).left();
            table32.row();
            ...
            //content of the chapter
            table32.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterThirtyThreeOFExodus() { // yung method/function ng per chapter.
            table33 = new Table();
            table33.top().left().padTop(200);
            table33.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "33";

            String chapterFirstTitle = "The Command to Leave Sinai"; // sample content titleParameter

            String firstContent = "1 The Lord said to Moses, “Depart; go up from here, you and the people whom you have brought up out of the land of Egypt, to the land of which I swore to Abraham, Isaac, and Jacob, saying, ‘To your offspring I will give it.’ \n" +
            ...
            String chapterSecondTitle = "The Tent of Meeting"; // sample content titleParameter

            String secondContent = "7 Now Moses used to take the tent and pitch it outside the camp, far off from the camp, and he called it the tent of meeting. And everyone who sought the Lord would go out to the tent of meeting, which was outside the camp. \n" +
            ...
            String chapterThirdTitle = "Moses' Intercession"; // sample content titleParameter

            String thirdContent = "12 Moses said to the Lord, “See, you say to me, ‘Bring up this people,’ but you have not let me know whom you will send with me. Yet you have said, ‘I know you by name, and you have also found favor in my sight.’ \n" +
            ...
            //book name
            table33.add(lblmainTitle).center().pad(20,0,0,20);
            table33.row(); // adding a row to the table

            //number of chapter
            table33.add(lblChapterNumber).pad(10,50,0,0).left();
            table33.row();
            ...
            //content of the chapter
            table33.add(txtFirstContent).pad(10,70,0,0).left();
            table33.row();
            ...
            //content of the second title
            table33.add(txtSecondContent).pad(10,70,0,0).left();
            table33.row();
            ...
            //content of the third title
            table33.add(txtThirdContent).pad(10,70,0,0).left();


        }


        public void chapterThirtyFourOFExodus() { // yung method/function ng per chapter.
            table34 = new Table();
            table34.top().left().padTop(200);
            table34.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "34";

            String chapterFirstTitle = "Moses Makes New Tablets"; // sample content titleParameter

            String firstContent = "1 The Lord said to Moses, “Cut for yourself two tablets of stone like the first, and I will write on the tablets the words that were on the first tablets, which you broke. \n" +
            ...
            String chapterSecondTitle = "The Covenant Renewed"; // sample content titleParameter

            String secondContent = "10 And he said, “Behold, I am making a covenant. Before all your people I will do marvels, such as have not been created in all the earth or in any nation. And all the people among whom you are shall see the work of the Lord, for it is an awesome thing that I will do with you.\n" +
            ...
            String chapterThirdTitle = "The Shining Face of Moses"; // sample content titleParameter
            ...
            //book name
            table34.add(lblmainTitle).center().pad(20,0,0,20);
            table34.row(); // adding a row to the table

            //number of chapter
            table34.add(lblChapterNumber).pad(10,50,0,0).left();
            table34.row();
            ...
            //content of the chapter
            table34.add(txtFirstContent).pad(10,70,0,0).left();
            table34.row();
            ...
            //content of the second title
            table34.add(txtSecondContent).pad(10,70,0,0).left();
            table34.row();
            ...
            //content of the third title
            table34.add(txtThirdContent).pad(10,70,0,0).left();

        }


        public void chapterThirtyFiveOFExodus() { // yung method/function ng per chapter.
            table35 = new Table();
            table35.top().left().padTop(200);
            table35.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "35";

            String chapterFirstTitle = "Sabbath Regulations"; // sample content titleParameter

            String firstContent = "1 Moses assembled all the congregation of the people of Israel and said to them, “These are the things that the Lord has commanded you to do.\n" +
            ...
            String chapterSecondTitle = "Contributions for the Tabernacle"; // sample content titleParameter
            ...
            String chapterThirdTitle = "Construction of the Tabernacle"; // sample content titleParameter

            String thirdContent = "30 Then Moses said to the people of Israel, “See, the Lord has called by name Bezalel the son of Uri, son of Hur, of the tribe of Judah; \n" +
            ...
            //book name
            table35.add(lblmainTitle).center().pad(20,0,0,20);
            table35.row(); // adding a row to the table

            //number of chapter
            table35.add(lblChapterNumber).pad(10,50,0,0).left();
            table35.row();
            ...
            //content of the chapter
            table35.add(txtFirstContent).pad(10,70,0,0).left();
            table35.row();
            ...
            //content of the second title
            table35.add(txtSecondContent).pad(10,70,0,0).left();
            table35.row();
            ...
            //content of the third title
            table35.add(txtThirdContent).pad(10,70,0,0).left();

        }


        public void chapterThirtySixOFExodus() { // yung method/function ng per chapter.
            table36 = new Table();
            table36.top().left().padTop(200);
            table36.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "36";

            String chapterFirstTitle = " "; // sample content titleParameter

            String firstContent = "1 “Bezalel and Oholiab and every craftsman in whom the Lord has put skill and intelligence to know how to do any work in the construction of the sanctuary shall work in accordance with all that the Lord has commanded.”\n" +
            ...
            //book name
            table36.add(lblmainTitle).center().pad(20,0,0,20);
            table36.row(); // adding a row to the table

            //number of chapter
            table36.add(lblChapterNumber).pad(10,50,0,0).left();
            table36.row();
            ...
            //content of the chapter
            table36.add(txtFirstContent).pad(10,70,0,0).left();

        }


        public void chapterThirtySevenOFExodus() { // yung method/function ng per chapter.
            table37 = new Table();
            table37.top().left().padTop(200);
            table37.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "37";

            String chapterFirstTitle = "Making the Ark"; // sample content titleParameter

            String firstContent = "1 Bezalel made the ark of acacia wood. Two cubits and a half was its length, a cubit and a half its breadth, and a cubit and a half its height.\n" +
            ...
            String chapterSecondTitle = "Making the Table"; // sample content titleParameter
            ...
            String chapterThirdTitle = "Making the Lampstand"; // sample content titleParameter

            String thirdContent = "17 He also made the lampstand of pure gold. He made the lampstand of hammered work. Its base, its stem, its cups, its calyxes, and its flowers were of one piece with it. \n" +
                    ...
                    "21 and a calyx of one piece with it under each pair of the six branches going out of it. 22 Their calyxes and their branches were of one piece with it. The whole of it was a single piece of hammered work of pure gold. \n" +
            ...
            String chapterFourthTitle = "Making the Altar of Incense"; // sample content titleParameter

            String fourthContent = "25 He made the altar of incense of acacia wood. Its length was a cubit, and its breadth was a cubit. It was square, and two cubits was its height. Its horns were of one piece with it. \n" +
            ...
            //book name
            table37.add(lblmainTitle).center().pad(20,0,0,20);
            table37.row(); // adding a row to the table

            //number of chapter
            table37.add(lblChapterNumber).pad(10,50,0,0).left();
            table37.row();
            ...
            //content of the chapter
            table37.add(txtFirstContent).pad(10,70,0,0).left();
            table37.row();
            ...
            //content of the second title
            table37.add(txtSecondContent).pad(10,70,0,0).left();
            table37.row();
            ...
            //content of the third title
            table37.add(txtThirdContent).pad(10,70,0,0).left();
            ...
            //content of the fourtn title
            table37.add(txtFourthContent).pad(10,70,0,0).left();


        }

        public void chapterThirtyEightOFExodus() { // yung method/function ng per chapter.
            table38 = new Table();
            table38.top().left().padTop(200);
            table38.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "38";

            String chapterFirstTitle = "Making the Altar of Burnt Offering"; // sample content titleParameter

            String firstContent = "1 He made the altar of burnt offering of acacia wood. Five cubits[a] was its length, and five cubits its breadth. It was square, and three cubits was its height. \n" +
            ...
            String chapterSecondTitle = "Making the Bronze Basin"; // sample content titleParameter

            String secondContent = "8 He made the basin of bronze and its stand of bronze, from the mirrors of the ministering women who ministered in the entrance of the tent of meeting.";

            String chapterThirdTitle = "Making the Court"; // sample content titleParameter
            ...
            String chapterFourthTitle = "Materials for the Tabernacle"; // sample content titleParameter

            String fourthContent = "21 These are the records of the tabernacle, the tabernacle of the testimony, as they were recorded at the commandment of Moses, the responsibility of the Levites under the direction of Ithamar the son of Aaron the priest. \n" +
            ...
            //book name
            table38.add(lblmainTitle).center().pad(20,0,0,20);
            table38.row(); // adding a row to the table

            //number of chapter
            table38.add(lblChapterNumber).pad(10,50,0,0).left();
            table38.row();
            ...
            //content of the chapter
            table38.add(txtFirstContent).pad(10,70,0,0).left();
            table38.row();
            ...
            //content of the second title
            table38.add(txtSecondContent).pad(10,70,0,0).left();
            table38.row();
            ...
            //content of the third title
            table38.add(txtThirdContent).pad(10,70,0,0).left();
            ...
            //content of the fourtn title
            table38.add(txtFourthContent).pad(10,70,0,0).left();

        }

        public void chapterThirtyNineOFExodus() { // yung method/function ng per chapter.
            table39 = new Table();
            table39.top().left().padTop(200);
            table39.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "39";

            String chapterFirstTitle = "Making the Priestly Garments"; // sample content titleParameter

            String firstContent = "1 From the blue and purple and scarlet yarns they made finely woven garments, for ministering in the Holy Place. They made the holy garments for Aaron, as the Lord had commanded Moses.\n" +
            ...
            //book name
            table39.add(lblmainTitle).center().pad(20,0,0,20);
            table39.row(); // adding a row to the table

            //number of chapter
            table39.add(lblChapterNumber).pad(10,50,0,0).left();
            table39.row();
            ...
            //content of the chapter
            table39.add(txtFirstContent).pad(10,70,0,0).left();


        }


        public void chapterFortyOFExodus() { // yung method/function ng per chapter.
            table40 = new Table();
            table40.top().left().padTop(200);
            table40.setFillParent(true);

            String mainTitle = " The Book of Exodus"; // sample main title

            String chapterNumber = "40";

            String chapterFirstTitle = "The Tabernacle Erected"; // sample content titleParameter
            ...
            String chapterSecondTitle = "The Glory of the Lord"; // sample content titleParameter
            ...
            //book name
            table40.add(lblmainTitle).center().pad(20,0,0,20);
            table40.row(); // adding a row to the table

            //number of chapter
            table40.add(lblChapterNumber).pad(10,50,0,0).left();
            table40.row();
            ...
            //content of the chapter
            table40.add(txtFirstContent).pad(10,70,0,0).left();
            table40.row();
            ...
            //content of the second title
            table40.add(txtSecondContent).pad(10,70,0,0).left();
