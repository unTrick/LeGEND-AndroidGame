...
public class BookOfNumbers {
    ...
    public void chapterOneOFNumbers() {
        ...
        String mainTitle = " The Book of Numbers";

        String chapterNumber = "1";

        String chapterFirstTitle = "A Census of Israel's Warriors";

        String firstContent = "1 The LORD spoke to Moses in the wilderness of Sinai, in the tent of meeting, on the first day of the second month, in the second year after they had come out of the land of Egypt, saying, \n" +
    ...
    public void chapterThreeOFNumbers() {
        ...
        String firstContent = "1 These are the generations of Aaron and Moses at the time when the LORD spoke with Moses on Mount Sinai. \n" +
                ...
                "4 But Nadab and Abihu died before the LORD when they offered unauthorized fire before theLORD in the wilderness of Sinai, and they had no children. So Eleazar and Ithamar served as priests in the lifetime of Aaron their father.\n";
        ...
        String secondContent = "5 And the LORD spoke to Moses, saying, \n" +
                ...
                "31 And their guard duty involved gthe ark, hthe table, ithe lampstand, jthe altars, the vessels of the sanctuary with which the priests minister, andkthe screen; all the service connected with these. \n" +
        ...
        String thirdContent = "40 And the LORD said to Moses, “List all the firstborn males of the people of Israel, from a month old and upward, taking the number of their names. \n" +
                "41 uAnd you shall take the Levites for me—I am the LORD—instead of all the firstborn among the people of Israel, and the cattle of the Levites instead of all the firstborn among the cattle of the people of Israel.” \n" +
        ...
        table3.add(txtThirdContent).pad(10,70,0,0).left();
    ...
    public void chapterFiveOFNumbers() {
        ...
        //content of the second title
        table5.add(txtSecondContent).pad(10,70,0,0).left();
        table5.row();
        ...
        //content of the third title
        table5.add(txtThirdContent).pad(10,70,0,0).left();
    ...
    public void chapterSevenOFNumbers() {
        ...
        String firstContent = "1 On the day when Moses had finished setting up the tabernacle and had anointed and consecrated it with all its furnishings and had anointed and consecrated the altar with all its utensils,\n" +
    ...
    public void chapterNineOFNumbers() {
        ...
        String firstContent = "1 And the LORD spoke to Moses in the wilderness of Sinai, in the first month of the second year after they had come out of the land of Egypt, saying, \n" +
        ...
        String secondContent = "15 On the day that the tabernacle was set up, the cloud covered the tabernacle, the tent of the testimony. And sat evening it was over the tabernacle like the appearance of fire until morning. \n" +
    ...
    public void chapterTenOFNumbers() {
        ...
        String secondContent = "11 In the second year, in the second month, on the twentieth day of the month, the cloud lifted from over the tabernacle of the testimony,\n" +
    ...
    public void chapterElevenOFNumbers() {
        ...
        String firstContent = "1 And the people complained in the hearing of the LORD about their misfortunes, and when the LORD heard it, his anger was kindled, and the fire of the LORD burned among them and consumed some outlying parts of the camp.\n" +
        ...
        String secondContent = "16 Then the LORD said to Moses, “Gather for me seventy men of the elders of Israel, whom you know to be the elders of the people and officers over them, and bring them to the tent of meeting, and let them take their stand there with you. \n" +
        ...
        String thirdContent = "31 Then a wind from the LORD sprang up, and it brought quail from the sea and let them fall beside the camp, about a day's journey on this side and a day's journey on the other side, around the camp, and about two cubits above the ground. \n" +
    ...
    public void chapterThirteenOFNumbers() {
        ...
        String firstContent = "The LORD spoke to Moses, saying, \n" +
                "2 “Send men to spy out the land of Canaan, which I am giving to the people of Israel. From each tribe of their fathers you shall send a man, everyone a chief among them.” \n" +
        ...
        String secondContent = "25 At the end of forty days they returned from spying out the land.26 And they came to Moses and Aaron and to all the congregation of the people of Israel in the wilderness of Paran, at Kadesh. They brought back word to them and to all the congregation, and showed them the fruit of the land. \n" +
    ...
    public void chapterFourteenOFNumbers() {
        ...
        String secondContent = "13 But Moses said to the LORD, “Then the Egyptians will hear of it, for you brought up this people in your might from among them, \n" +
        ...
        String fourthContent = "39 When Moses told these words to all the people of Israel, the people mourned greatly. \n" +
                ...
                "43 For there the Amalekites and the Canaanites are facing you, and you shall fall by the sword. Because you have turned back from following the LORD, theLORD will not be with you.” \n" +
        ...
        //content of the third title
        table14.add(txtThirdContent).pad(10,70,0,0).left();
        ...
        table14.add(txtFourthContent).pad(10,70,0,0).left();
    ...
    public void chapterFifteenOFNumbers() {
        ...
        String firstContent = "1 The LORD spoke to Moses, saying, \n" +
                ...
                "4 then he who brings his offering shall offer to the LORD a grain offering of a tenth of an ephah of fine flour, mixed with a quarter of a hin of oil;  and you shall offer with the burnt offering, or for the sacrifice, a quarter of a hin of wine for the drink offering for each lamb. \n" +
                ...
                "20 Of the first of your dough you shall present a loaf as a contribution; like a ocontribution from the threshing floor, so shall you present it. \n" +
        ...
        //content of the third title
        table15.add(txtThirdContent).pad(10,70,0,0).left();
        ...
        //content of the fourtn title
        table15.add(txtFourthContent).pad(10,70,0,0).left();
    ...
    public void chapterSixteenOFNumbers() {
        ...
        String firstContent = "1 Now Korah the son of Izhar, son of Kohath, son of Levi, and Dathan and Abiram the sons of Eliab, and on the son of Peleth, sons of Reuben, took men. \n" +
    ...
    public void chapterEighteenOFNumbers() {
        ...
        String firstContent = "1 So the LORD said to Aaron, “You and your sons and your father's house with you shall bear iniquity connected with the sanctuary, and you and your sons with you shall bear iniquity connected with your priesthood. \n" +
    ...
    public void chapterTwentyOFNumbers() {
        ...
        String firstContent = "1 And the people of Israel, the whole congregation, came into the wilderness of Zin in the first month, and the people stayed in Kadesh. And Miriam died there and was buried there.";
        ...
        String thirdContent = "10 Then Moses and Aaron gathered the assembly together before the rock, and he said to them, “Hear now, you rebels: shall we bring water for you out of this rock?” \n" +
        ...
        String fourthContent = "14 Moses sent messengers from Kadesh to the king of Edom: “Thus says your brother Israel: You know all the hardship that we have met:\n" +
        ...
        //content of the third title
        table20.add(txtThirdContent).pad(10,70,0,0).left();
        ...
        table20.add(txtFourthContent).pad(10,70,0,0).left();
        ...
        table20.add(txtFifthContent).pad(10,70,0,0).left();
    ...
    public void chapterTwentyOneOFNumbers() {
        ...
        String firstContent = "1When the Canaanite, the king of Arad, who lived in the Negeb, heard that Israel was coming by the way of Atharim, he fought against Israel, and took some of them captive. \n" +
        ...
        String secondContent = "4 From Mount Hor they set out by the way to the Red Sea, to go around the land of Edom. And the people became impatient on the way.\n" +
    ...
    public void chapterTwentyTwoOFNumbers() {
        ...
        String firstContent = "1 Then the people of Israel set out and camped in the plains of Moab beyond the Jordan at Jericho. \n" +
                ...
                "10 And Balaam said to God, “Balak the son of Zippor, king of Moab, has sent to me, saying, 11 ‘Behold, a people has come out of Egypt, and it covers the face of the earth. Now come, curse them for me. Perhaps I shall be able to fight against them and drive them out.’” \n" +
                "12 God said to Balaam, “You shall not go with them. You shall not curse the people, for they are blessed.” \n" +
                "13 So Balaam rose in the morning and said to the princes of Balak, “Go to your own land, for theLORD has refused to let me go with you.” \n" +
        ...
        String secondContent = "22 But God's anger was kindled because he went, and the angel of the LORD took his stand in the way as his adversary. Now he was riding on the donkey, and his two servants were with him. \n" +
    ...
    public void chapterTwentyThreeOFNumbers() {
        ...
        String secondContent = "13 And Balak said to him, “Please come with me to another place, from which you may see them. You shall see only a fraction of them and shall not see them all. Then curse them for me from there.” \n" +
    ...
    public void chapterTwentyFourOFNumbers() {
        ...
        String firstContent = "1 When Balaam saw that it pleased the LORD to bless Israel, he did not go, as at other times, to look for omens, but set his face toward the wilderness. \n" +
                ...
                "17 I see him, but not now; I behold him, but not near: a star shall come out of Jacob, and a scepter shall rise out of Israel; it shall crush the forehead of Moab and break dow all the sons of Sheth.\n" +
    ...
    public void chapterTwentySixOFNumbers() {
        ...
        String firstContent = "1 After the plague, the LORD said to Moses and to Eleazar the son of Aaron, the priest, \n" +
                ...
                "26 The sons of rZebulun, according to their clans: of Sered, the clan of the Seredites; of Elon, the clan of the Elonites; of Jahleel, the clan of the Jahleelites.\n" +
                ...
                "54 To a large tribe you shall give a large inheritance, and to a small tribe you shall give a small inheritance; every tribe shall be given its inheritance in proportion to its list. 55 But the land shall be divided by lot. According to the names of the tribes of their fathers they shall inherit. \n" +
    ...
    public void chapterTwentySevenOFNumbers() {
        ...
        String firstContent = "1 Then drew near the daughters of Zelophehad the son of Hepher, son of Gilead, son of Machir, son of Manasseh, from the clans of Manasseh the son of Joseph. The names of his daughters were: Mahlah, Noah, Hoglah, Milcah, and Tirzah. \n" +
    ...
    public void chapterTwentyEightOFNumbers() {
        ...
        String secondContent = "9 “On the Sabbath day, two male lambs a year old without blemish, and two tenths of an ephah of fine flour for a grain offering, mixed with oil, and its drink offering: \n" +
        ...
        String thirdContent = "11 “At the beginnings of your months, you shall offer a burnt offering to the LORD: two bulls from the herd, one ram, seven male lambs a year old without blemish;\n" +
                ...
                "13 and a tenth of fine flour mixed with oil as a grain offering for every lamb; for a burnt offering with a pleasing aroma, a food offering to theLORD. \n" +
        ...
        String fifthContent = "26 “On the day of the firstfruits, when you offer a grain offering of new grain to the LORD at your Feast of Weeks, you shall have a holy convocation. You shall not do any ordinary work, \n" +
        ...
        //content of the fourth title
        table28.add(txtFourthContent).pad(10,70,0,0).left();
        ...
        //content of the fifth title
        table28.add(txtFifthContent).pad(10,70,0,0).left();
    ...
    public void chapterTwentyNineOFNumbers() {
        ...
        String firstContent = "1 “On the first day of the seventh month you shall have a holy convocation. You shall not do any ordinary work. It is a day for you to blow the trumpets, \n" +
        ...
        String thirdContent = "12 “On the fifteenth day of the seventh month you shall have a holy convocation. You shall not do any ordinary work, and you shall keep a feast to the LORD seven days. \n" +
                ...
                "20 “On the third day eleven bulls, two rams, fourteen male lambs a year old without blemish, 21 with the grain offering and the drink offerings for the bulls, for the rams, and for the lambs, in the prescribed quantities; \n" +
        ...
        //content of the second title
        table29.add(txtSecondContent).pad(10,70,0,0).left();
        table29.row();
        ...
        //content of the third title
        table29.add(txtThirdContent).pad(10,70,0,0).left();
    ...
    public void chapterThirtyOFNumbers() {
        ...
        String secondContent = "3 “If a woman vows a vow to the LORD and binds herself by a pledge, while within her father's house in her youth, \n" +
                ...
                "8 But if, on the day that her husband comes to hear of it, he opposes her, then he makes void her vow that was on her, and the thoughtless utterance of her lips by which she bound herself. And theLORD will forgive her. \n" +
    ...
    public void chapterThirtyOneOFNumbers() {
        ...
        String firstContent = "1 The LORD spoke to Moses, saying, \n" +
                ...
                "3 So Moses spoke to the people, saying, “Arm men from among you for the war, that they may go against Midian to execute theLORD's vengeance on Midian. \n" +
                ...
                "16 Behold, these,  on Balaam's advice, caused the people of Israel to act treacherously against the LORDin the incident of Peor, and so the plague came among the congregation of the LORD. \n" +
    ...
    public void chapterThirtyTwoOFNumbers() {
        ...
        String firstContent = "1 Now the people of Reuben and the people of Gad had a very great number of livestock. And they saw the land of Jazer and the land of Gilead, and behold, the place was a place for livestock. \n" +
                ...
                "40 And Moses gave Gilead to Machir the son of Manasseh, and he settled in it. 41 And Jair the son of Manasseh went and captured their villages, and called them Havvoth-jair. \n" +
    ...
    public void chapterThirtyThreeOFNumbers() {
        ...
        String firstContent = "1 These are the stages of the people of Israel, when they went out of the land of Egypt by their companies under the leadership of Moses and Aaron. \n" +
    ...
    public void chapterThirtyFiveOFNumbers() {
        ...
        String firstContent = "1 The LORD spoke to Moses in the plains of Moab by the Jordan at Jericho, saying,\n" +
                ...
                "4 The pasturelands of the cities, which you shall give to the Levites, shall reach from the wall of the city outward a thousand cubits1 all around. \n" +
    ...
    public void chapterThirtySixOFNumbers() {
        ...
        String firstContent = "1 The heads of the fathers' houses of the clan of the people of Gilead the son of Machir, son of Manasseh, from the clans of the people of Joseph, came near and spoke before Moses and before the chiefs, the heads of the fathers' houses of the people of Israel.\n" +
